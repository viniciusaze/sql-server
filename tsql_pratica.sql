...
-- CONVERTENDO FLOAT PARA VARCHAR
...
BEGIN
        ...
        PRINT 'Vendas para ' + @CPF + ' - ' + @NOME + ' NO MÊS ' + CONVERT(VARCHAR(2), @MES) + ' E ANO ' + CONVERT(VARCHAR(4),@ANO) + ' FOI DE ' + TRIM(STR(@TOTAL_VENDAS, 15, 2)); -- AQUI ESTÁ A CONVERSÃO
        SET @I = @I + 1;
END;

-- SALVANDO EM UMA TABELA TEMPORÁRIA
DECLARE @CPF VARCHAR(11);
DECLARE @NOME VARCHAR(100);
DECLARE @NUMERO_CLIENTES INT;
DECLARE @I INT;
